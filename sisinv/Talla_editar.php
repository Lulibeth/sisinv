...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, descripcion,(SELECT nombre  FROM public.estatus where id=talla.estatus) as estatusdes ,estatus
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Talla > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_talla.php" name="edprovee" id="edprovee" method="post"> 

<div align="center">
<h2 align="center">Editar Talla</h2>
  ...
  <table class='table table-bordered' style="width:90%" >
    <tr>
      ...
      <td width="15%"><p align="center"><em><strong>Talla</strong></em></p>      </td>
