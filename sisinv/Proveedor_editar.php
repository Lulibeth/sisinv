...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, descripcion, rif, telefono, telefono_f,(SELECT nombre  FROM public.estatus where id=proveedor.estatus) as estatusdes , usuario, ip ,estatus
  FROM factu_inv.proveedor
  where
 id=".$id_.";";
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Proveedor > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_proveedor.php" name="edprovee" id="edprovee" method="post"> 
...
<h2 align="center">Editar Proveedor</h2>
  ...
  <table class='table table-bordered' style="width:90%" >
    <tr>
      ...
      <td width="15%"><p align="center"><em><strong>Nombre o Razón Social </strong></em></p>      </td>
      <td width="20%"><div align="justify">
<input type="text" class="form-control" id="descrip" name="descrip" value="<?Php echo $descrip; ?>">
      </div></td>
	  </tr>
    <tr>
      <td><div align="center"><em><strong>Rif o Cedula</strong></em></div></td>
      <td><div align="justify">
        <input type="text" class="form-control" name="prerif" id="prerif" value="<?Php echo $prerif; ?>">
      </div></td>
	  <td><div align="center"><em><strong>Telefono</strong></em></div></td><td><div align="justify">
        <input type="text" class="form-control" name="telef" value="<?Php echo $telef; ?>">
      </div></td>
	  </tr>
    <tr>
      <td height="30"><div align="center"><em><strong>Telefono</strong></em></div></td>
      <td><div align="justify">
        <input type="text" class="form-control" id="telef_" name="telef_" value="<?Php echo $telef_; ?>">
      </div></td>
