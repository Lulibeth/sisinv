...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, descripcion,estatus,(SELECT nombre  FROM public.estatus where id=iva.estatus) as estatusdes, usuario, fecha,  ip,   n_calcular 
  FROM factu_inv.iva
  where
 id=".$id_.";";
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Iva > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_iva.php" name="ediva" id="ediva" method="post"> 

<div align="center">
<h2 align="center">Editar Iva</h2>

  <table class='table table-bordered' style="width:90%" >
    <tr>
      <td width="15%"><div align="center"><em><strong>ID</strong></em></div></td>
      <td width="15%"><div align="justify"><input name="id_iva" id="id_iva" type="hidden" value="<?Php echo $CODIGO; ?>">
