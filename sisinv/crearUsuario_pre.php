...
//alert("csd");
		    ...
		    var cedula =document.getElementById('cedula').value; 
				libAjax('form1re','contenido/nombrepersona.php?numero=4&cedula='+cedula,'nombres_inscr');
...
<div align="left" ><img src="images/logoeditable2.png" style="width:25%; height:45%; position:fixed;"></div>
<div class="error-top" style="width:60%">
<div class="container-fluid">
<div class="validation-form"> <div id="mensaje"></div>
<form  action="acceso/entradaRegis.php" method="post" name="form1re" id="form1re"  onsubmit="return addMsj();">
...
$conex->conectar($conex->servidor,$conex->usuario,$conex->password,$conex->BD);  
	...
	$prefijocedu="SELECT id, descripcion
  FROM persona.prefijo_cedula where estatus_id=1 and id in ('1','2') order by id";  
 $filasprefijocedu=$conex->sentencia($prefijocedu);
 while($daprefijocedu=$conex->filas($filasprefijocedu))
						{ 
						 $id_pref=$daprefijocedu["id"];
						 $descripcion_pref=$daprefijocedu["descripcion"];
	echo "<option value='$id_pref'>$descripcion_pref</option>";
	}
	?>
</select></td>
