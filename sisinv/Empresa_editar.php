...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, nombre,direccion,estatus,(SELECT nombre  FROM public.estatus where id=empresa.estatus) as estatusdes, rif, fecha, ip, num_telef
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Empresa > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_empresa.php" name="edprovee" id="edprovee" method="post"> 
...
<h2 align="center">Editar Empresa</h2>
  ...
  <table class='table table-bordered' style="width:90%" >
    <tr>
      ...
      <td width="15%"><p align="center"><em><strong>Rif</strong></em></p>      </td>
      <td width="20%"><div align="justify">
       <input type="text" class="form-control" id="rif" name="rif" value="<?Php echo $rif; ?>">
      </div></td>
	  
	  <td width="15%"><p align="center"><em><strong>Nombre de la Empresa</strong></em></p>      </td>
      <td width="20%"><div align="justify">
       <input type="text" class="form-control" id="nombre_em" name="nombre_em" value="<?Php echo $nombre_em; ?>">
      </div></td>
	  </tr>
    <tr>
	  <td width="15%"><p align="center"><em><strong>N&uacute;mero de Tel&eacutefono </strong></em></p>      </td>
      <td width="20%"><div align="justify">
       <input type="text" class="form-control" id="telef" name="telef" value="<?Php echo $telef; ?>">
      </div></td>
	  
	  <td width="15%"><p align="center"><em><strong>Direcci&oacute;n</strong></em></p>      </td>
      <td width="20%"><div align="justify">
       <input type="text" class="form-control" id="direc" name="direc" value="<?Php echo $direc; ?>">
      </div></td>
