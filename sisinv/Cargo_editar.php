...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, nombre,estatus,(SELECT nombre  FROM public.estatus where id=cargo.estatus) as estatusdes
  FROM empresa.cargo
  where
 id=".$id_.";";
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Cargo > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_cargo.php" name="edprovee" id="edprovee" method="post"> 
...
<h2 align="center">Editar Empresa</h2>
  ...
  <table class='table table-bordered' style="width:90%" >
    <tr>
      ...
      <td width="15%"><p align="center"><em><strong>Cargo</strong></em></p>      </td>
