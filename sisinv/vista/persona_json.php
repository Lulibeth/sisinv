...
@session_start();
	...
	if($pagina==0)
		$pagina=1;
	$pagina--;
	$sql="SELECT id, precedu,cedula, nombre, apellido,  (SELECT nombre  FROM public.estatus where id=estatus) as descestatus
  FROM persona.persona
				where
					concat(precedu,cedula,' ',apellido,' ',nombre)
					ilike '%".$nombre."%' 
