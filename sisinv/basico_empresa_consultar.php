...
<div id="tabs" class="tabs"> <!--3-->
                                     <div class="sub-heard-part">
									        <ol class="breadcrumb m-b-0">
											   ...
											   <li class="active">Empresa > Consultar</li>
										    </ol>
									 </div>
<div class="graph"> <!--4-->
				<nav>
					<ul>
						<li><a href="#section-1" class="icon-cup"><i class="glyphicon glyphicon-tag"></i>Empresa</a></li>
...
<div class="content tab"> <!--5-->
	<section id="section-1">
			<div class="mediabox" style="width:100%;">
               <a href="index.php?s=coempresa" target="_blank"> <img src= 'imagenes/ver-detalles_318-1493__.png' width='50' height='50'/>Consultar</a>
			</div>
	</section>
																						
	<section id="section-2">
			<div class="mediabox" style="width:100%;">
               <a href="index.php?s=cocargo" target="_blank"> <img src= 'imagenes/ver-detalles_318-1493__.png' width='50' height='50'/>Consultar</a>
			</div>
	</section>
