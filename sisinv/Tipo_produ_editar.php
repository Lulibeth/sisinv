...
$id_=$_REQUEST['nest'];
 $sql="SELECT id, descripcion,estatus,(SELECT nombre  FROM public.estatus where id=tip_produ.estatus) as estatusdes, usuario, fecha,  ip 
										...
										<!--/sub-heard-part-->
											 <div class="sub-heard-part">
													   <ol class="breadcrumb m-b-0">
															...
															<li class="active">Tipo Producto > Editar</li>
														</ol>
											</div>	
											
<form action="guardar/E_tipo_produ.php" name="edtipo" id="edtipo" method="post"> 

<div align="center">
<h2 align="center">Editar Tipo Producto</h2>

  <table class='table table-bordered' style="width:90%" >
    <tr>
      <td width="15%"><div align="center"><em><strong>ID</strong></em></div></td>
      <td width="15%"><div align="justify"><input name="id_tipo" id="id_tipo" type="hidden" value="<?Php echo $CODIGO; ?>">
	  <?Php echo $CODIGO; ?></div></td>
	  </tr>
    <tr>
	  <td><div align="center"><em><strong>Tipo de Producto</strong></em></div></td>
      <td><div align="justify">
        <input type="text" class="form-control" name="des_arti" id="des_arti" value="<?Php echo $des_arti; ?>">
      </div></td>
	  </tr>
    <tr>
